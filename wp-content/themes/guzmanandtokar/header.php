...
<head>
	...
	<link rel="stylesheet" href="<?php echo esc_url($theme_uri); ?>/css/owl.carousel.css" media="all">
...
<header class="site-header"> 
	<div class="container">
		<div class="spanish-btn desk-top"><a hre="<?php echo esc_url( home_url('/') ); ?>" class="cmn-btn">Se Habla Español</a></div>
...
<div class="hdr-rgt">
	<nav id="main-navigation">
       ...
       <div class="header-number"><a href="tel:+16264277128">Call: (626) 427-7128</a></div>
	   
</div>
    </div>
    		<div class="spanish-btn mobile"><a href="<?php echo esc_url( home_url('/') ); ?>" class="cmn-btn">Se habla español</a></div>
	...
	<div class="header-sticky">
		<div class="container">
			...
			<div class="sicky-cnt sticky-mobile-logo"><a href="<?php echo home_url(); ?>"><img
						...
						width="" height=""></a></div>
			<div class="sticky-cnt sticky-call-wrap"><a href="tel:+16264277128">Call</a></div>
		</div>
	</div>
