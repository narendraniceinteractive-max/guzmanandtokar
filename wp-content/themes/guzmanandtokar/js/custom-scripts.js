...
if (headers.length > 0) {
    ...
    // EXTRA: Click on content closes it
...
jQuery(document).ready(function ($) {
    function mobilesliders() {
        ...
        if (windowWidth <= 991) {
            if (!$('.attorney-blk').hasClass('owl-loaded')) {
                $('.attorney-blk').addClass('owl-carousel').owlCarousel({
                    loop: true,
                    autoplay: true,
                    autoplayTimeout: 5000,
                    autoplayHoverPause: true,
            ...
            if ($('.attorney-blk').hasClass('owl-loaded')) {
                ...
                $('.attorney-blk').find('.owl-stage-outer').children().unwrap();
            }
        }
    }
...
jQuery(document).ready(function ($) {
    function mobilesliders() {
        ...
        if (windowWidth <= 991) {
            if (!$('.practice-blk').hasClass('owl-loaded')) {
                $('.practice-blk').addClass('owl-carousel').owlCarousel({
                    loop: true,
                    autoplay: true,
                    autoplayTimeout: 5000,
                    autoplayHoverPause: true,
            ...
            if ($('.practice-blk').hasClass('owl-loaded')) {
                $('.practice-blk')
                    .trigger('destroy.owl.carousel')
                    .removeClass('owl-carousel owl-loaded owl-drag');
                $('.practice-blk').find('.owl-stage-outer').children().unwrap();
            }
        }
    }
